...
export const saveBasicInfo = async (payload) => {
    try {
        const response = await axiosInstance.post(
            "/api/user/setting/basic-info/save",
            payload
        );
...
export const saveBillingDetails = async (payload) => {
    try {
        const response = await axiosInstance.post(
            "/api/user/setting/billing-details/save",
            payload
        );
...
export const deleteSupport = async (payload) => {
    try {
        const response = await axiosInstance.post(
            "/api/user/setting/support/delete",
            payload
        );
...
export const saveSocialMedia = async (payload) => {
    try {
        const response = await axiosInstance.post(
            "/api/user/setting/social-media/save",
            payload
        );
