...
const ProLayouts = ({ children }) => {
  ...
  const menuRoutes = {
    ...
    routes: [
      {
        path: "/dashboard",
        name: t("dashboard", { defaultValue: "Dashboard" }),
        icon: <HomeOutlined />,
      },
      {
        path: "/campaigns",
        name: t("campaigns", { defaultValue: "Campaigns" }),
      ...
      {
        path: "/domains",
        name: t("domains", { defaultValue: "Domains" }),
        icon: <GlobalOutlined />,
      },
      {
        path: "/contact",
        ...
        routes: [
          ...
          {
            path: "/contact/groups",
            name: t("groups", { defaultValue: "Groups" }),
            icon: <DatabaseOutlined />,
          },
          {
            path: "/contact/custom-fields",
            name: t("custom.fields", { defaultValue: "Custom Fields" }),
            icon: <DatabaseOutlined />,
          },
        ],
      },
      ...
      {
        path: "/webhooks",
        name: t("webhooks", { defaultValue: "WebHooks" }),
        icon: <MdWebhook />,
      },
      {
        path: "/media",
        name: t("media", { defaultValue: "Media" }),
